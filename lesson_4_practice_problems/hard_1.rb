...
file = SecretFile.new("secret info", logger)
p file.data
...
moto = Motorcycle.new
p moto.range
boat = Catamaran.new(4, 4, 40, 30)
p boat.range
mtrboat = Motorboat.new(20, 35)
dbl_boat = Catamaran.new(2, 2, 40, 30)
cat2 = Catamaran.new(3,3,10,40)
p dbl_boat.range
p mtrboat.range
p cat2.range
