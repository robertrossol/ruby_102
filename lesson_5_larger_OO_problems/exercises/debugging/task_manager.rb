...
class TaskManager
  ...
  def display_high_priority_tasks
    ...
    #explanation: tasks now refers to the unassigned local variable (opposed to the getter or setter method), so tasks is currently nil and calling select on nil throws the error. 
      task.priority == :high
    end
